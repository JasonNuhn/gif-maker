/**
 * Created by alkin on 25.08.2016.
 */
var data = [
    {
...
for(var i = 0; i < data.length; i++) {
    var name = data[i].family;

    if (name == "Open Sans" || name == "Roboto" || name == "Slabo 27px" || name == "Lato") {

        result.fonts[counter] = {
            id: counter+1,
            fontFamily:  data[i].family + ', ' + data[i].category,
            name: data[i].family,
            fontSize: 18,
            fileUrl: data[i].files.regular,
            localFileName: data[i].family + ".ttf",
            cloudinaryFontName: ""
        }
        counter++;
    }
